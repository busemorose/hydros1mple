...
#' @param f_haude A numeric vector of one factor for each month (12 in total). Used for Haude's method. Detailed in german \url{https://www.climate-service-center.de/products_and_publications/publications/detail/063341/index.php.de}. Default values correspond to "unknown land surface".
